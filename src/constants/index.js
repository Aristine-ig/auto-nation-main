...
export const pricing = [
  {
    id: "0",
    title: "Basic",
    description: "For solopreneurs & starters",
    price: "0",
    features: [
      "Auto-reply to DMs & Story mentions",
      "Basic keyword triggers e.g price,collab",
      "email support",
  ...
  },
  {
    ...
    features: [
      "Auto-reply to DMs & Story mentions",
      "Ulimited keyword triggers",
      "Priority support to solve issues quickly",
      "Unlimited AI-generated replies/month",
...
export const benefits = [
  ...
  },
  {
    ...
    text: "Lets users quickly automate their tasks.",
